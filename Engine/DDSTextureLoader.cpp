...
//--------------------------------------------------------------------------------------
//Custom Modified to allow forceSRGB on more functions
...
namespace
{
		...
		size_t* bitSize)
	{
		...
		*header = hdr;
		//offset is the size of the binary which doesnt contain color data
		...
		*bitSize = fileInfo.EndOfFile.LowPart - offset;
		...
		//DebugLog("si", "Random color is: ", *(*bitData + 0));
		//DebugLog("si", "Random color is: ", *(*bitData + 1));
		//DebugLog("si", "Random color is: ", *(*bitData + 2));
		//DebugLog("si", "Size is: ", hdr->width * hdr->height * 6 * 3);
